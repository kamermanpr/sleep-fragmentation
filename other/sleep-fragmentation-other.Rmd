...
pill <- data %>%
    select(id, period, pill.evening, pill.morning)
```
...
friedman.test(vf.during_mN ~ period | id,
              data = vonfrey)
# Pairwise posthoc - During ischaemia
posthoc.friedman.conover.test(y = vonfrey$vf.during_mN,
                              groups = vonfrey$period,
                              blocks = vonfrey$id,
                              p.adjust.method = 'holm')
```
