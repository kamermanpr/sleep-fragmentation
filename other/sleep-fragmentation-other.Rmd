...
# Pairwise posthoc 
posthoc.friedman.conover.test(sleep.quality ~ period | id, 
                              data = sleep.qual)
```
...
# Pairwise posthoc 
posthoc.friedman.conover.test(morning.vigilance ~ period | id, 
                              data = morning.vig)
```
...
# Pairwise posthoc 
posthoc.friedman.conover.test(pin.prick_mN ~ period | id, data = pinprick)
```
...
posthoc.friedman.conover.test(poms.morning ~ period | id, data = poms)
# Friedman test - Evening
friedman.test(poms.evening ~ period | id, data = poms)
# Pairwise posthoc - Evening
posthoc.friedman.conover.test(poms.evening ~ period | id, data = poms)
```
